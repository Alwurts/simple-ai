...
`chat-page` pulls in composer, tool, and worked, plus the page layout and thinking row. The CLI also installs shadcn `sidebar`, `message`, `bubble`, `attachment`, and `message-scroller`.

...
`chat-page` pulls in composer, tool, and worked, plus the layout the page uses. The CLI also installs shadcn `sidebar`, `message`, `bubble`, `attachment`, and `message-scroller`.

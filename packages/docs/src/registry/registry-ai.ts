...
const DEFAULT_AGENT_ADD_INSTRUCTIONS =
	"Import the agent into the agents list in the agents/agents-registry.ts file and to the tools list in the tools/tools-registry.ts file.\n";
...
const agents: Registry["items"] = [
	{
		...
		docs: DEFAULT_AGENT_ADD_INSTRUCTIONS,
		dependencies: ["ai"],
...
const tools: Registry["items"] = [
	...
	},
	{
		...
		files: [
			{
				type: "registry:lib",
				path: "ai/tools/firecrawl-tool.ts",
...
const lib: Registry["items"] = [
	{
		...
		files: [
			{
				type: "registry:lib",
				path: "ai/agents/agents-registry.ts",
				target: "lib/ai/agents/agents-registry.ts",
			},
			{
				type: "registry:lib",
				path: "ai/tools/tools-registry.ts",
	...
	},
	{
		...
		files: [
			{
				type: "registry:lib",
				path: "ai/agent-route-respond.ts",

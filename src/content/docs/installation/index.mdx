...
alwurts/ai is built on top of [shadcn/ui](https://ui.shadcn.com), so you'll need to set it up first:
...
Once you have shadcn/ui set up, you can start adding alwurts/ai components to your project. Each component page in our documentation includes a command you can run to add it to your project:

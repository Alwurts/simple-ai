...
<ComponentPreview name="generate-text-node-demo" description="An example of a Generate Text node with model selection and dynamic tool outputs" componentContainerClassName="p-0" />

...
<ComponentPreview name="editable-handle-demo" description="An example of a node with dynamic handles - try adding new inputs or outputs, editing their labels, or removing them" componentContainerClassName="p-0" />

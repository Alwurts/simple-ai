...
- [x] Add suggestions to the chat
- [x] Add Note resizable Node
- [ ] Add MCP Node <https://github.com/vercel/ai/pull/9127>
- [ ] Add schema ai generation to schema editor
- [ ] Add Human in the loop <https://ai-sdk.dev/cookbook/next/human-in-the-loop>
- [ ] Add support for widgets
- [ ] Add support for Vercel Durable Workflows
- [ ] Add testing for the different modules
